...
export default function Home({
  ...
  return (
    <>
      <Navbar />
      <div className="h-screen flex flex-row justify-start py-10 mb-20">
        {" "}
          ...
          <div className="h-screen bg-gradient-to-b from-gray-900 to-black overflow-scroll flex flex-col">
            <div className="w-44 font-medium h-80 absolute right-12 max-sm:w-36 text-center z-20">
              <button
                ...
                className="bg-blue-500 w-full py-2 px-2 mt-2 flex items-center justify-around rounded   text-white font-bold"
              >
                Select Profile
                {!expand ? (
                ...
                <div className="bg-blue-500">
                  {
                    <ul className="bg-blue-500">
                      <li
                        className="p-2 mt-2 text-l hover:bg-black cursor-pointer text-white"
                        onClick={() => setFilter(internData)}
                      >
                        Intern
                      </li>
                      <li
                        className="p-2 text-l hover:bg-black cursor-pointer text-white"
                    ...
                    <div className="p-3 border-spacing-1 border-2 bg-blue-100 bg-gradient-to-r max-w-sm rounded overflow-hidden shadow-lg">
                      <div className="CardImg">
                        <Image
                          ...
                          alt="sal-dApp"
                          src={
                            "https://sal-dapp.infura-ipfs.io/ipfs/" + e.image
                          }
                        />
                      </div>
                      ...
                      <div className=" text-center text-3xl font-sans Title">
                        ...
                        <div className="CardData font-bold mb-2 text-gray-700 text-base ">
                          <div className="Text font-bold text-xl mb-2">
                            Owner
                            <AccountBoxIcon />
                          </div>
                          <div className="Text font-bold text-xl mb-2">
