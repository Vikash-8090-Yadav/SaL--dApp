...
export default function About() {
    return (
      <>
      <div>
<div className="w-full my-20 z-50 sticky  rounded-3xl px-6 bg-zinc-600 bg-gradient-to-r from-indigo-800">

<div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  <h1 className="text-extrabold text-5xl text-white text-center font-bold font-serif">How we did it ?</h1>
      <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
          <div className="max-w-xl mb-6">
            ...
            <p className="text-white text-base md:text-lg"> Polygon believes in Web3 for all. Polygon is a decentralised Ethereum scaling platform that enables developers to build scalable 
          ...
          <Link href="https://polygon.technology/">
            <a className="flex object-cover sm:mr-64 mr-32 object-top items-center text-white border-2 justify-center w-full sm:px-10 py-4 leading-6 bg-pink-700 bg-gradient-to-l from-indigo-800 hover:bg-pink-700 hover:bg-gradient-to-r hover:from-indigo-800 rounded-xl font-black"
    >
       Know More
    </a>
    </Link>
      ...
      <Image  src ={spheron} width ={400} height = {400} alt ="hero-image" className = "rounded-md duration-200 hover:scale-110 hover:overflow-hidden"/>  
        ...
        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
          ...
          <div className="max-w-xl mb-6">
            ...
            <p className="text-white text-base md:text-lg">A peer-to-peer hypermedia protocol designed to preserve and grow humanitys knowledge by making the web upgradeable, resilient, and more open.
          ...
          <Link href="https://ipfs.tech/">
            <a
      className="flex object-cover sm:mr-64 mr-32 object-top items-center text-white border border-2 justify-center w-full sm:px-10 py-4 leading-6 bg-pink-700 bg-gradient-to-l from-indigo-800   rounded-xl font-black"
    >
       Get Started</a>
    </Link>
          </div>
      ...
      <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
          <div className="max-w-xl mb-6">
            ...
            <p className="text-white text-base md:text-lg">Is to bring the next billion software creators online. We build powerful, simple tools and platforms for learners, educators, and developers.
