          ...
          <div className = "flex gap-2 justify-between max-md:flex-col max-md:text-center">   
            <div className = "mb-5">
              ...
              <form action = "" className = "flex flex-row max-sm:flex-col max-sm:items-center ">
                <input type = "text" className = "text-gray-500 w-2/3 p-2 pr-4 mr-2 rounded-md focus:border-blue-400 max-sm:mb-2 focus:outline-none " placeholder = "Enter your email" />
                <button className = "bg-blue-500 hover:bg-blue-700 duration-300 w-1/3 rounded-md  p-2 font-semibold ">Subscribe</button>
              </form>
            </div>
