					...
					<form>
						<div className="inpiut-name ">
							<input
								...
								className="w-full px-3 py-2 placeholder-gray-500 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-white-700 dark:text-black dark:placeholder-gray-500 dark:border-gray-800  name"
								name="FirstName"
							/>
							<span>
								<input
									...
									className="w-full px-3 py-2 placeholder-gray-500 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-white-700 dark:text-black dark:placeholder-gray-500 dark:border-gray-800 name name"
									name="LastName"
								/>
							</span>
						</div>
						<div className="inpiut-name">
							<input
								onChange={Handler?.FormHandler}
								value={Handler?.form?.WallletAddress}
								type="text"
								placeholder="Wallet Address"
								className="w-full px-3 py-2 placeholder-gray-500 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-white-700 dark:text-black dark:placeholder-gray-500 dark:border-gray-800 name text-name"
								name="WallletAddress"
							/>
						</div>
						<div className="inpiut-name">
							<i className="fa fa-useer lock"></i>
							<select
								onChange={Handler?.FormHandler}
								value={Handler?.form?.Position}
								className="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500 name text-name"
								name="Position"
							>
    ...
    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-non "
						...
						<div className=" inpiut-name ">
							{Uploading == true ? (
								...
								<button
									onClick={uploadfiles}
									className=" rounded-xl bg-gradient-to-l from-indigo-500 button"
								>
									Upload to IPFS
								</button>
							) : (
